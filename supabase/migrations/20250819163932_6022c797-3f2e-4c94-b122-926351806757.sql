-- Remover todas as versões anteriores da função para resolver conflito de sobrecarga
DROP FUNCTION IF EXISTS public.update_rematricula_fields(bigint, text, bigint, text, text, text, text, text, text, text, text, text);

-- Recriar apenas a versão atual com p_turno_2026
